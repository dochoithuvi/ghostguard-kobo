#!/bin/sh
# DCPRO GhostGuard Kobo v0.8.3.3 fast Status. Network update check is background-only.
set -u
...
show_status(){
  ...
  echo 'GhostGuard Kobo 0.8.3.3 Protect Beta';echo "Engine: $ENG | Auto mode: $MODE";echo "License: $(license_summary)";update_summary;echo "Profile: $(friendly "$PS")"
